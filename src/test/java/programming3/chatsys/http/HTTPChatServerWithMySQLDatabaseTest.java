...
class HTTPChatServerWithMySQLDatabaseTest {

    MySQLDatabase db;
    // set the MySQL information and uncomment the test to run
    ...
    void setUp() throws IOException, SQLException {
        db = new MySQLDatabase(dbHost, dbPort, dbName, dbUser, dbPassword);
        connection = DriverManager.getConnection(
                "jdbc:mysql://"+dbHost+":"+dbPort+"/?serverTimezone=UTC", dbUser, dbPassword
        );
